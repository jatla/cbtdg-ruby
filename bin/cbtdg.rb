#!/usr/bin/env ruby
require File.expand_path(File.dirname(__FILE__) + '/../lib/cbtdg-ruby')
require 'optparse'
...
ConstraintBasedTestDataGenerator.instance.generateTestDataSetForModel $dataModel, outputFile
