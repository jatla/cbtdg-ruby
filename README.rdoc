== cbtdg-ruby {<img src="https://travis-ci.org/jatla/cbtdg-ruby.png?branch=master" alt="Build Status" />}[https://travis-ci.org/jatla/cbtdg-ruby]
...
* Running the tool
	...
	Example: cbtdg.rb -m model.rb -o testData.txt
